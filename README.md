...
> **Status:** under construction (stage S1 — the skeleton runs, no features yet).
...
Open <http://localhost:8000> on this computer. `docker compose logs vault` shows the app's
